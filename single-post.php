      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9 post-content" data-aos="fade-up">
            ...
            <!-- ======= Comments ======= -->
            <div class="comments">
              <h5 class="comment-title py-4" style="color: #e73667">2 Comments</h5>
            ...
            <div class="row justify-content-center mt-5">
              ...
              <div class="col-lg-12">
                <h5 class="comment-title" style="color: #e73667">Leave a Comment</h5>
                <div class="row">
                  <div class="col-lg-6 mb-3">
                    <label for="comment-name">Name</label>
                    <input type="text" class="form-control" style="border: 1px solid #999; border-radius: 8px; height: 40px" id="comment-name" placeholder="Enter your name">
                  </div>
                  <div class="col-lg-6 mb-3">
                   <label for="comment-email">Email</label>
                     <input type="text" class="form-control" id="comment-email" placeholder="Enter your email" style="border: 1px solid #999; border-radius: 8px; height: 40px">
                   </div>
                  ...
                  <div class="col-12" style="width: 28%">
